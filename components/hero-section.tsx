...
return (
  <section ref={ref} className="relative h-screen w-full flex items-center justify-center text-white overflow-hidden">
    ...
    {/* Menu Button 
      ...
      className="absolute top-4 right-4 md:top-8 md:right-8 z-40" // Positionnement en haut à droite, z-index 40
    >
      <Button
        variant="ghost" // Utilise la variante ghost pour un fond transparent
        className="w-12 h-12 rounded-lg bg-gray-800/50 text-white hover:bg-gray-700/70 backdrop-blur-sm shadow-lg transition-all duration-200 flex items-center justify-center"
        aria-label="Menu"
      >
    ...
    >
      <div className="flex flex-col items-center justify-center space-y-2">
        ...
        <p className="text-lg md:text-xl text-gray-300 max-w-2xl">
          Nous développons des sites web et des applications mobiles adaptés à vos besoins, qu’il s’agisse d’un projet simple ou d’une plateforme sur mesure. Laissez-vous emporter  
        </p>
      </div>
      ...
      <div className="w-full flex justify-center items-end gap-8 mb-4">
        <motion.div
          ...
          transition={{
            y: { duration: 2.5, repeat: Infinity, repeatType: "reverse", ease: "easeInOut", delay: 1.2 },
            x: { duration: 3, repeat: Infinity, repeatType: "reverse", ease: "easeInOut", delay: 1.5 },
          }}
        >
          <Image
            src="/iphone.svg"
        ...
        <motion.div
          ...
          transition={{
            y: { duration: 2.8, repeat: Infinity, repeatType: "reverse", ease: "easeInOut", delay: 1.4 },
            x: { duration: 3.2, repeat: Infinity, repeatType: "reverse", ease: "easeInOut", delay: 1.7 },
          }}
        >
          <Image
            src="/pc-portable.svg"
      ...
      <Link href="#contact">
        <Button className="mt-8 px-8 py-6 text-lg font-semibold rounded-full bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 transition-all shadow-lg">
