  ...
  return (
    ...
    >
      <Link href="#contact">
        ...
        >
          <Button className="px-6 py-4 text-base font-semibold rounded-full bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 transition-all shadow-lg text-white">
            Lancer mon projet
          </Button>
        </motion.div>
      </Link>
